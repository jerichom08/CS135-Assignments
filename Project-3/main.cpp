...
int main(){
    ...
    vector<Profemon> profemons = {maryash, shostak, raja, epstein, shankar, levitan};
    Trainer trainer(profemons);

    trainer.printProfedex();

    cout << trainer.removeProfemon("Epstein") << endl;
